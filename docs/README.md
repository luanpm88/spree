...
| MIGRATION_RUNBOOK.md *(gitignored, không có trong bản clone)* | lập trình viên | Đưa một shop từ 5.2/5.4 lên 5.6.1, chạy 7 lần. Ba quả mìn đã biết, thứ tự bắt buộc, và §11 nói rõ chỗ chưa kiểm được. |
